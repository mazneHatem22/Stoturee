      ...
      <Container>
        <div>
          ...
          <p className="mt-4" >
            ...
            <a href="malito:www.stoture.com">www.stoture.com</a> (hereinafter
            referred to as "the site"), you agree to the collection and use of
        ...
        <div className="mt-5">
          ...
          <p className="mt-4">
            ...
            hereafter devised. You also grant us the right to sublicense these
        ...
        <div className="mt-5">
          ...
          <h6>-When you have given your consent;</h6>
          <h6>
            -Or when we use your data in ways you would reasonably expect as
            part of managing our business.
          </h6>
        </div>
        ...
        <div className="mt-5">
          ...
          <h6>
            -The right to erasure when we no longer need to process your data;
          </h6>
          <h6>

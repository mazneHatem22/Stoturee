      ...
      <Container className='h-100'>
       ...
       <img className='arrow-style'  src={svg} alt=''/>
        ...
        style={{width:"88%" ,transform:"translateY(50%)"}}>
            ...
            <p className='text-center mb-0 mt-3 p-text'>We documented the first edition of the Dubai World Obstacle Championship through promotional videos and professional <br/> photography, capturing the energy and excitement of the event.</p>
             
             
            </div>
            
        </div>
        <div className='mt-5 position-absolute' style={{backgroundColor:"#ffffff" , padding:"30px " ,width:"88%" , bottom:"2px" , left:"50%",transform:"translateX(-50%)" }}>
            <div className=' d-flex justify-content-between text-center align-items-center promo-text text-black'>
                ...
                <p className='mb-0'> <span style={{color:"#606060"}}>Project: </span> Event Coverage</p>
            </div>
        </div>

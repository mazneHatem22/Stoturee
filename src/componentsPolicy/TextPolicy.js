      ...
      <Container>
        <div>
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            <a href="mailto:www.stoture.com">www.stoture.com</a> (hereinafter
            referred to as "users") are fully aware of their rights regarding
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            refrain from using the website and exit.
          </p>
        </div>
        <div className="mt-5">
          <h1 className="mt-4">
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            <a href="milto:www.stoture.com">www.stoture.com</a>, such as filling
            out surveys, sending feedback to Stoture, seeking information about
            Stoture services, or applying for jobs, Stoture may request users to
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            mobile phone number, date of birth, workplace, and employer
            information. Stoture may use the user's personal information to
            provide services, improve service quality, enhance website
            functionality, promote advertising and promotional activities,
            analyze website usage, and inquire about user experiences with third
            parties. Stoture is entitled to collect information that does not
        ...
        <div className="mt-5">
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            used for a maximum of two years in our database for recruitment
            purposes, or for a shorter period if we are informed of your desire
        ...
        <div className="mt-5">
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            protect and secure the information we collect online.
          </p>
        </div>
        <div className="mt-5">
        ...
        <div className="mt-5">
          ...
          <p className="mt-4" style={{ fontWeight: "600" }}>
            ...
            their personal information in accordance with applicable laws.
          </p>
        </div>
        <div className="mt-5">
